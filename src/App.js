...
const audioMappings = {
  ...
  EFFORT: '/assets/audios/EFFORT.m4a',
  RESOLVE: '/assets/audios/RESOLVE.m4a',
  RELATION: '/assets/audios/RELATION.m4a',
  ORGANIZE: '/assets/audios/ORGANIZE.m4a',
  PERFECT: '/assets/audios/PERFECT.m4a',
  COMPASSION: '/assets/audios/COMPASSION.m4a',
  LOYAL: '/assets/audios/LOYAL.m4a',
  RESPONSIBLE: '/assets/audios/RESPONSIBLE.m4a',
  CALL: '/assets/audios/CALL.m4a',
  SUMONE: '/assets/audios/SUMONE.m4a',
  TIKTOK: '/assets/audios/TIKTOK.m4a',
  TALK: '/assets/audios/TALK.m4a',
  WAIT: '/assets/audios/WAIT.m4a',
  PLAY: '/assets/audios/PLAY.m4a',
  HUG: '/assets/audios/HUG.m4a',
  EYE: '/assets/audios/EYE.m4a',
  KISS: '/assets/audios/KISS.m4a',
  SAME: '/assets/audios/SAME.m4a',
  PLAYLIST: '/assets/audios/PLAYLIST.m4a',
  NAME: '/assets/audios/NAME.m4a',
  MEAL: '/assets/audios/MEAL.m4a',
  RESPECT: '/assets/audios/RESPECT.m4a',
  PLAN: '/assets/audios/PLAN.m4a',
  BALANCE: '/assets/audios/BALANCE.m4a',
  CLOSE: '/assets/audios/CLOSE.m4a',
  JOY: '/assets/audios/JOY.m4a',
  MISS: '/assets/audios/MISS.m4a',
  COMFORT: '/assets/audios/COMFORT.m4a',
  PRESENCE: '/assets/audios/PRESENCE.m4a',
  RESPONSE: '/assets/audios/RESPONSE.m4a'
};
